...
export default function SignUpForm() {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      setLoading(true);
      await register(firstName, lastName, email, password, "manager");
      navigate("/dashboard");
    } catch (err) {
        ...
        <div className="flex h-full w-full flex-col justify-between px-10 py-12 xl:px-16">
          ...
          <div className="max-w-xl">
            ...
            <h1 className="mb-5 text-4xl font-semibold leading-tight xl:text-5xl">
              Create your SiteTrack account and start managing projects with clarity.
            </h1>
            <p className="mb-8 max-w-lg text-base leading-7 text-gray-300">
              Set up your account to organise tasks, track workers, monitor site progress, and keep
              your team aligned from one central dashboard.
            </p>
            <div className="grid gap-4 sm:grid-cols-3">
              {[
                { val: "Fast", desc: "Quick account setup" },
                { val: "Secure", desc: "Protected user access" },
                { val: "Ready", desc: "Built for site teams" },
              ].map((item) => (
          ...
          <div className="text-sm text-gray-500">Built for supervisors, managers, and field teams.</div>
        </div>
      </div>
      ...
      <div className="flex w-full items-center justify-center px-6 py-10 sm:px-10 lg:w-1/2 xl:w-[45%]">
        <div className="w-full max-w-md">
          ...
          <div className="mb-8">
            ...
            <h1 className="mb-2 text-3xl font-semibold text-gray-900 dark:text-white">Create your account</h1>
            <p className="text-sm leading-6 text-gray-500 dark:text-gray-400">
              Enter your details to create a SiteTrack account and access your dashboard.
            </p>
          </div>
          ...
          <div className="mt-8 rounded-2xl border border-gray-200 bg-gray-50 px-4 py-4 dark:border-gray-800 dark:bg-white/[0.03]">
            <p className="text-sm leading-6 text-gray-600 dark:text-gray-400">
              ...
              <Link to="/signin" className="font-semibold text-brand-500 hover:text-brand-600 dark:text-brand-400">
                Sign in
              </Link>
            </p>
          </div>
