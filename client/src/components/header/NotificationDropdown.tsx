    ...
    <div className="relative">
      ...
      >
        ...
        <div className="flex flex-col items-center justify-center py-10 text-center">
          <svg className="mb-3 text-gray-300 dark:text-gray-600" width="40" height="40" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <p className="mt-1 text-xs text-gray-400 dark:text-gray-500">
            Task updates and site alerts will appear here.
          </p>
        </div>
      </Dropdown>
    </div>
